...
// @RestController
// public class PostApiController3 {
// // SELECT * FROM post WHERE id = ?
// // 구체적으로 뭘 달라고 요청 - body x
// @GetMapping("/post/{id}")
// public String test1111(@PathVariable int id) {
// return "주세요 id : " + id;
// }
...
// @GetMapping("/post")
// public String search111(String title) {
...
// @PostMapping("/post")
// public String test2222(String title, String content) {
...
// // API 문서
// @PutMapping("/post/{id}")
// public String test3333(String title, String content, @PathVariable int id) {
...
// // 구체적으로 삭제해주세요 - body x
// @DeleteMapping("/post")
// public String test4444(String title) {
