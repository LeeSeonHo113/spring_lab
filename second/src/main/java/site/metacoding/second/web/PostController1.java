...
// Post post11 = new Post(1, "제목1", "내용1");
// Post post22 = new Post(2, "제목2", "내용2");
// Post post33 = new Post(3, "제목3", "내용3");
// Post post44 = new Post(4, "제목4", "내용4");
// Post post55 = new Post(5, "제목5", "내용5");
...
// // 1. DB에 연결해서 SELECT해야 함.
// // 2. ResultSet을 JavaObject으로 변경
// Post post = new Post(1, "제목1", "내용1");
// // 3. request에 담기
// model.addAttribute("post", post);

// return "post/detail1"; // RequestDispatcher로 forward함 = request가 복제됨.
// }
// }